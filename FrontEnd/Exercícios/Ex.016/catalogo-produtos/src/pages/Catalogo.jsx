...
export default function Catalogo() {
  ...
  useEffect(() => {
    setTimeout(() => {
      const produtosMock = [
        { nome: "Notebook", preco: 3500, descricao: "Notebook potente", imagem: "https://via.placeholder.com/150" },
        { nome: "Celular", preco: 2500, descricao: "Smartphone moderno", imagem: "https://via.placeholder.com/150" }
      ];
